...
const Main = () => {
  return (
    <main className="background w-full h-full">
      <div className="lg:max-w-[78rem] md:max-w-[88rem] m-auto py-[3.5rem] max-w-[85rem]  flex lg:space-x-[17rem] md:justify-around flex-col justify-center items-center space-y-[3rem] sm:flex-row">
        <div>
